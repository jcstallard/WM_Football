...
RU_clean['Is_Successful'] = (
    # Runs: Use efficiency rules based on down/distance/gain
    (
        (RU_clean['R/P'] == 'R') & (
    ...
    |
    # Passes: Must be complete and gain > 0
    (
        (RU_clean['R/P'] == 'P') & 
        (RU_clean['GAIN'] > 0)
    )
